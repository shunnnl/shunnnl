...
<img src="https://capsule-render.vercel.app/api?type=waving&color=auto&height=280&text=hello%20shunnnl!&descAlign=20" width="100%"/>
...
## 🎓 Education
**삼성청년SW·AI아카데미(SSAFY) 12기 수료**

## 🏆 Awards
| 대회명 | 주관 | 수상 | 날짜 |
|--------|------|:------:|------|
| 삼성청년SW·AI아카데미 12기 자율 프로젝트 (기업연계) | 삼성전자주식회사 | **🥇우수상** | 2025.05.22 |
| 삼성청년SW·AI아카데미 12기 특화 프로젝트 (웹기술) | 삼성전자주식회사 | **🥇우수상** | 2025.04.11 |
| 삼성청년SW·AI아카데미 12기 공통 프로젝트 (웹기술) | 삼성전자주식회사 | **🥇우수상** | 2025.02.21 |
| 청년친화형 기업 ESG 지원사업 리모트인턴십 프로그램 프로젝트 | CJ 올리브네트웍스 | **🥇최우수상** | 2023.11 |
| KNU K-Digital Platform 데이터를 활용한 해커톤 | KNU 데이터융복합연구원 | **🥈우수상** | 2022.11 |

## 👩🏻‍💻 Projects

| 프로젝트 | 소개 | 기간 | 인원 | 역할 |
|---------|-------------|-----------|-----------|------|
| **[SESIM](https://github.com/shunnnl/SESIM)**  | 보안 AI를 고객 인프라에 직접 배포해 안심하고 사용하는 SaaS 플랫폼 | 2025.04.14 ~ 2025.05.22 (6주) | 6명 | BE |
| **[어디가농](https://github.com/shunnnl/WhereToFarm)** | 귀농지 추천 및 작물 수익을 예측하는 빅데이터 기반 귀농 플랫폼 | 2025.02.24 ~ 2025.04.11 (7주) | 6명 | BE |
| **[MeeBot](https://github.com/shunnnl/MeeBot)** | AI 사회자와 함께하는 발표회 플랫폼 | 2025.01.06 ~ 2025.02.21 (7주) | 6명 | BE |
...
![EC2](https://img.shields.io/badge/Amazon%20EC2-Instance-FF9900?logo=amazonec2&logoColor=white)
![S3](https://img.shields.io/badge/Amazon%20S3-Storage-569A31?logo=amazons3&logoColor=white)
![CloudFormation](https://img.shields.io/badge/CloudFormation-IaC-5C2D91?logo=awscloudformation&logoColor=white)
![IAM](https://img.shields.io/badge/AWS%20IAM-RBAC-0052CC?logo=amazonaws&logoColor=white)
...
#### Tools
![Git](https://img.shields.io/static/v1?label=Git&message=CLI&labelColor=4B4B4B&color=F05032&logo=git&logoColor=white)
![Jira](https://img.shields.io/static/v1?label=Jira&message=Agile&labelColor=4B4B4B&color=0052CC&logo=jira&logoColor=white)
![Postman](https://img.shields.io/static/v1?label=Postman&message=API&labelColor=4B4B4B&color=FF6C37&logo=postman&logoColor=white)
![Notion](https://img.shields.io/static/v1?label=Notion&message=Docs&labelColor=4B4B4B&color=000000&logo=notion&logoColor=white)
